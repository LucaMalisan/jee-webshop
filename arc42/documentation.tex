...
\begin{figure}[H]
\centering
\includegraphics[width=300pt]{db/db_model.png}
\caption{ERD Diagramm der Datenbank}
\end{figure}
...
\section{Testing \& Abnahmekriterien}
Die Business-Logik des Webshops wird mithilfe von Unit-Tests getestet. Für die REST-API wird ein Postman Script verwendet.
Als Abnahmekriterium gilt, dass 100\% der Unit Tests erfolgreich sein müssen und alle Postman-Anfragen mit Status 200/201 erfolgen müssen
